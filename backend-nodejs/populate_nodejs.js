...
const { Course, Event, JobVacancy, User } = require('./src/models');
...
const populateDatabase = async () => {
  try {
    ...
    console.log(' Poblando TechHub UPE con datos de ejemplo...');
    ...
    const events = [
      ...
      },
      {
        ...
        event_date: new Date(Date.now() + 62 * 24 * 60 * 60 * 1000), // 62 days from now
      ...
      // Business & Marketing Events - Paraguay
      {
        ...
        event_date: new Date(Date.now() + 38 * 24 * 60 * 60 * 1000), // 38 days from now
      ...
      },
      {
        ...
        url: "https://www.usaid.gov/paraguay",
        event_date: new Date(Date.now() + 28 * 24 * 60 * 60 * 1000), // 28 days from now
      ...
      },
      {
        ...
        event_date: new Date(Date.now() + 12 * 24 * 60 * 60 * 1000), // 12 days from now
        location: "Online",
        is_online: true,
        category: "Contabilidad",
      ...
      // Design Events - Paraguay
      {
        ...
        event_date: new Date(Date.now() + 55 * 24 * 60 * 60 * 1000), // 55 days from now
      ...
      },
      {
        ...
        event_date: new Date(Date.now() + 18 * 24 * 60 * 60 * 1000), // 18 days from now
      ...
      // HR & Administration Events - Paraguay
      {
        ...
        event_date: new Date(Date.now() + 42 * 24 * 60 * 60 * 1000), // 42 days from now
        location: "Centro de Convenciones Mariscal López",
        is_online: false,
        category: "Recursos Humanos",
        image_url: "https://images.unsplash.com/photo-1521791136064-7986c2920216?w=400&h=250&fit=crop"
      },
      {
        ...
        event_date: new Date(Date.now() + 33 * 24 * 60 * 60 * 1000), // 33 days from now
    ...
    const companies = [
      {
        email: "rrhh@vrcexpress.com.py",
        name: "VRC Express S.A.",
        role: "empresa",
        is_verified: true,
      ...
      {
        email: "hiring@techpysolutions.com.py",
      ...
      {
        email: "hr@creativapy.com.py",
        name: "CreativaPy Agency",
        role: "empresa",
        is_verified: true,
        company_name: "CreativaPy Agency",
        company_document: "80012346-8"
      },
      {
        email: "ventas@beautyparadise.com.py",
        name: "Beauty Paradise Paraguay",
        role: "empresa",
        is_verified: true,
        company_name: "Beauty Paradise Paraguay",
        company_document: "80012347-9"
      },
      {
        email: "rrhh@expressmetro.com.py",
        name: "Express Metropolitana",
        role: "empresa",
        is_verified: true,
        company_name: "Express Metropolitana",
        company_document: "80012348-0"
      },
      {
        email: "contabilidad@grupoemp.com.py",
        name: "Grupo Empresarial Paraguayo",
        role: "empresa",
        is_verified: true,
        company_name: "Grupo Empresarial Paraguayo",
        company_document: "80012349-1"
      },
      {
        email: "empleos@ude.edu.py",
        name: "Universidad del Este (UDE)",
        role: "empresa",
        is_verified: true,
        company_name: "Universidad del Este (UDE)",
        company_document: "80012350-7"
      },
      {
        email: "hiring@bairesdev.com.py",
        name: "BairesDev Paraguay",
        role: "empresa",
        is_verified: true,
        company_name: "BairesDev Paraguay",
        company_document: "80012351-8"
      }
    ];
    ...
    await User.deleteMany({ role: "empresa" });
    
    // Insert companies first
    console.log('🏢 Insertando empresas de ejemplo...');
    const insertedCompanies = await User.insertMany(companies);
    console.log(`✅ ${insertedCompanies.length} empresas insertadas`);
    
    // Create jobs with company IDs
    const jobs = [
      {
      ...
      },
      {
        ...
        company_id: insertedCompanies[5].id,
        company_name: "Grupo Empresarial Paraguayo",
      ...
      },
      {
        ...
        company_id: insertedCompanies[7].id,
        company_name: "BairesDev Paraguay",
    ...
    console.log(' Insertando vacantes de ejemplo...');
    await JobVacancy.insertMany(jobs);
    console.log(` ${jobs.length} vacantes insertadas`);
